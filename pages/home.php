<div class="container">
    ...
    <div class="menu-grid-container">
        ...
        <div class="menu-grid-item">Item 4</div>
    </div>
</div>
...
<body>
    ...
    <main id="dynamic-page-wrapper" data-page="black-and-white" tabindex="-1">
<section class="hero">
    <h1 class="sub-title">The Life of an Artist</h1>
    <p class="page-title">Black and white</p>
</section>
<div id="main-content-area">
    <div class="slideshow-container" data-slides="/json-files/black-and-white-paintings.json" data-autoplay="true"
