<div class="landing-menu">
    ...
    <div class="landing-menu-item category"><a href="/restoration" class="category-link"
            data-gallery="encaustic_paintings" aria-label="Go to Restoration Projects">Restoration Projects</a>
        <p>Matrix parabola quotient variable coefficient binomial exponent modulus integer polynomial function domain
            ...
            tangent cosine sine asymptote factor divisor.</p>
    </div>

    <div class="landing-menu-item category"><a href="/artworks" class="category-link"
            data-gallery="project_series_paintings" aria-label="Go to Artworks Catefory Page">Artworks Catefory Page</a>
