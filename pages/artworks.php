<main id="main" class="page-content-wrapper" tabindex="-1">
  <section class="body-paragraphs" aria-labelledby="artworks-page-heading">
    ...
    <p>
      <a href="/drips?showSlideshow=true" class="dropcap mnu-change" data-gallery="drips" aria-label="Go to the Drips Series">D</a>
      rips Series — Gravity, chance, and lyrical accident, where gesture and flow shape surface.
    </p>

    <p>
      <a href="/encaustic?showSlideshow=true" class="dropcap mnu-change" data-gallery="encaustic" aria-label="Go to the Encaustic Gallery">E</a>
